...
class TwittersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create twitter" do
    assert_difference("Twitter.count") do
      post twitters_url, params: { twitter: { desciption: @twitter.desciption, username: @twitter.username } }
    end
  ...
  test "should update twitter" do
    patch twitter_url(@twitter), params: { twitter: { desciption: @twitter.desciption, username: @twitter.username } }
